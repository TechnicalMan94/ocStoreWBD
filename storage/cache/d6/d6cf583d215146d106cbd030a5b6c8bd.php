...
/* install/step_2.twig */
class __TwigTemplate_ab2a6f2de539ad574a9075f24c28f18f extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    <div class=\"col-sm-9\">
      <form action=\"";
        ...
        // line 39
        if ((($context["php_version"] ?? null) >= "5.4")) {
            // line 40
...
";
    ...
    {
        return new Source("", "install/step_2.twig", "/var/www/rvd/data/www/rvd.dev.webdes.by/install/view/template/install/step_2.twig");
    }
}
