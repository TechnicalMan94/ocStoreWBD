	...
	public function index()
	{
		if ($this->config->get('feed_google_sitemap_status')) {
			...
			foreach ($products as $product) {
				...
				if ($product['image']) {
					$output .= '  <image:image>';
					$output .= '  <image:loc>' . $this->model_tool_image->resize($product['image'], $this->config->get('theme_default_image_popup_width'), $this->config->get('theme_default_image_popup_height')) . '</image:loc>';
