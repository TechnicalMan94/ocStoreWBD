...
class ControllerAccountReturn extends Controller {
	...
	public function index() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($return_total) ? (($page - 1) * $this->config->get('theme_default_product_limit')) + 1 : 0, ((($page - 1) * $this->config->get('theme_default_product_limit')) > ($return_total - $this->config->get('theme_default_product_limit'))) ? $return_total : ((($page - 1) * $this->config->get('theme_default_product_limit')) + $this->config->get('theme_default_product_limit')), $return_total, ceil($return_total / $this->config->get('theme_default_product_limit')));
