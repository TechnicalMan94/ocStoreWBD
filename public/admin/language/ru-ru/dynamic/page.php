...
$_['entry_related']          = 'Похожие страницы';
$_['entry_product_related']  = 'Связанные товары';
$_['entry_layout']           = 'Макет';

$_['tab_general']            = 'Основное';
$_['tab_data']               = 'Данные';
$_['tab_links']              = 'Связи';
$_['tab_fields']             = 'Доп. поля';
$_['tab_image']              = 'Изображения';
$_['tab_seo']                = 'SEO';
$_['tab_design']             = 'Дизайн';

$_['help_keyword']           = 'Должно быть уникальным на всю систему. Заменяйте пробелы на тире.';
$_['help_tag']               = 'Разделяются запятой';
$_['help_noindex']           = 'Закрыть от индексации поисковыми системами';
$_['help_main_category']     = 'Категория, используемая для формирования канонического URL';
...
$_['error_keyword_exists']   = 'Данный SEO URL уже используется!';
